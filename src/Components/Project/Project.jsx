...
const Project = ({
	...
	const [likeGroup, setLikeGroup] = useState({
		liked: false,
		count: likes,
		image: likeNegro,
	})
	const [dislikeGroup, setDislikeGroup] = useState({
		disliked: false,
		count: dislikes,
		image: dislikeNegro,
	})
						...
						<section className="nright col-md-4">
								...
								<div className="containerLikesProject">
									...
									<h6>
										<img
											...
											onClick={handleLike}
										></img>{" "}
										<span>{likeGroup.count}</span>
									</h6>
									<h6>
										<img
											src={dislikeGroup.image}
											alt="Dislike"
											onClick={handleDislike}
										></img>{" "}
										<span>{dislikeGroup.count}</span>
									</h6>
								</div>

								<div className="containerUserProject">
									<h6>
										Emprendedore/s: <span>{user.name}</span>
									</h6>
									<img
										className="userImg"
										src={user.photo}
							...
							<div className="two">
								<a href="" target="_blank">
									<img className="rrssImg" src={ig} alt="img Instagram" />
								</a>
							</div>
						</section>
					</div>
